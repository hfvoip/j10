 ...
 */
public class WdrcFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_wdrc, container, false);
    }
    public void refresh_ui(byte[] arr_data) {
        //ToastUtils.showShort("Wdrc Fragment：" + StringUtils.toHex(arr_data, " "));
    }
}