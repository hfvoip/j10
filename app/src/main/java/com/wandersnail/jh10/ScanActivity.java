...
public class ScanActivity extends BaseActivity  implements View.OnClickListener {
    ...
    private void showPopupWindow() {
        //设置contentView
        View contentView = LayoutInflater.from(ScanActivity.this).inflate(R.layout.fragment_memory, null);
        ...
        //显示PopupWindow
        View rootview = LayoutInflater.from(ScanActivity.this).inflate(R.layout.activity_scan, null);
        mPopWindow.showAtLocation(rootview, Gravity.CENTER_VERTICAL, 0, 0);
    ...
    private void update_earimage() {
        boolean exists_l = false;
        boolean exists_r = false;
